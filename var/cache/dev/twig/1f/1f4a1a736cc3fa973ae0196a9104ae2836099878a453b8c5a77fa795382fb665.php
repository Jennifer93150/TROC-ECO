...
class __TwigTemplate_ed190e9f57b049066287a0de6cc5a087e693f627db84fb25e8a1e6db80323870 extends \Twig\Template
{
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Troc'Eco | Catégorie maison";
    ...
    public function block_contenuPrincipal($context, array $blocks = [])
    {
        ...
        echo "<section>
    <div class=\"shadow-lg\">
        <h1 class=\"py-3 my-5 text-center\">Catégorie Maison</h1>
    </div>
    <div class=\"container\">
        <div class=\"row\">
        ";
            ...
            echo "            <div class=\"card mb-3 card-size\" style=\"max-width: 1120px;\">
                <div class=\"row g-0\">
                    ...
                    <!-- j'ai du retirer l'affichage dynamique recuperant les photos de la bdd car un probleme s'est produit et l'envoi de file ne s'effectuait plus asset('/uploads/brochures/' ~ produit.photo)-->
                        <a href=\"#\"><img src=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("/uploads/brochures/seche-cheveux-605b85de55ef2.jpeg"), "html", null, true);
...
{% block title %}Troc'Eco | Catégorie maison{% endblock %}
        ...
        {% for produit in produits %}
            <div class=\"card mb-3 card-size\" style=\"max-width: 1120px;\">
                <div class=\"row g-0\">
                    <div class=\"col-md-4 image\">
                    <!-- j'ai du retirer l'affichage dynamique recuperant les photos de la bdd car un probleme s'est produit et l'envoi de file ne s'effectuait plus asset('/uploads/brochures/' ~ produit.photo)-->
                        <a href=\"#\"><img src=\"{{ asset('/uploads/brochures/seche-cheveux-605b85de55ef2.jpeg') }}\" class=\"img-thumbnail\" alt=\"photo-produit\"/></a>
                    </div>
                    <div class=\"col-md-8\">
                        <div class=\"card-body background-maison\">

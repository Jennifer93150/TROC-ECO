...
return [
    ...
    'recherche' => [[], ['_controller' => 'App\\Controller\\DefaultController::affiche'], [], [['text', '/recherche']], [], []],
    ...
    'ajout' => [[], ['_controller' => 'App\\Controller\\Produit1Controller::new'], [], [['text', '/ajouter']], [], []],
    'liste' => [['id'], ['_controller' => 'App\\Controller\\Produit1Controller::liste'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id'], ['text', '/categorie/liste']], [], []],
    'deleteproduit' => [['id'], ['_controller' => 'App\\Controller\\Produit1Controller::delete'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id'], ['text', '/produit/delete']], [], []],
    'annonce' => [['id'], ['_controller' => 'App\\Controller\\Produit1Controller::annonces'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id'], ['text', '/categorie/annonce']], [], []],
